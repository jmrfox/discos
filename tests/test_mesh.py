...
class TestCreateTorusMesh:
    ...
    def test_create_torus_custom_params(self):
        ...
        assert (
            abs(mesh.metadata["surface_area_theoretical"] - expected_surface_area)
            < 1e-10
        )
...
class TestMeshManager:
    ...
    def simple_torus(self):
        ...
        return create_torus_mesh(
            major_radius=10.0, minor_radius=2.0, major_segments=20, minor_segments=12
        )
...
class TestMeshManagerIntegration:
    ...
    def test_torus_to_manager_workflow(self):
        ...
        torus = create_torus_mesh(
            major_radius=15.0, minor_radius=3.0, major_segments=24, minor_segments=16
        )
    ...
    def test_mixed_mesh_types_comparison(self):
        ...
        torus = create_torus_mesh(
            major_radius=8.0, minor_radius=2.0, major_segments=20, minor_segments=12
        )
