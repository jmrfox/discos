...
The main objective of skeletonization is to represent a 3D mesh in a compact form that captures its essential shape and connectivity. The DISCOS algorithm achieves this by slicing up the original mesh along the z-axis into a series of slices.
